...
The Exchange Rates API can be used to get real time exchange rates, past/historical rates, and perform quick currency conversion between multiple currencies.
